    ...
    $('.frmAddUsers').validate({
        ...
        submitHandler: function (form) {
            ...
            if (!IsEditMode) {
                ...
                $.post(
                    ...
                    function (value) {
                        if (value == 'exist') {
                            swal(
                                'Warning',
                                'SecurityQuestionsAlready Exist!',
                                'warning'
                            )
                            return;
                        }
                        ...
                        if (value != 'error') {
                            swal(
                                'Success',
                                'SecurityQuestions Saved Successfully!',
                                'success'
                            )
                            Reset();
                ...
                $.post(
                    "../SecurityQuestions/EditQuestions",
                    $(".frmAddUsers").serialize(),
                    function (value) {
                        if (value == 'exist') {
                            swal(
                                'Warning',
                                'Questions Name Already Exist!',
                                'warning'
                            )
                            return;
                        }
...
var LoadGridData = function () {
    $.ajax({
        type: "POST",
        cache: false,
        url: "../SecurityQuestions/LoadGrid",
        processData: false,
        contentType: false,
